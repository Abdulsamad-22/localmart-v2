  ...
  return (
    <div className="space-y-5">
      ...
      <div
        ...
        ${agreed ? "border-[#009688] bg-[#009688]/5" : "border-gray-200"}`}
      >
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[0.875rem] text-gray-500 mt-1 leading-relaxed">
              LocalMart charges a{" "}
              <strong className="text-gray-800">10% service fee</strong> on
              every completed transaction. This fee is automatically deducted
