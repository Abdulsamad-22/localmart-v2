  ...
  return (
    <div className="space-y-6">
      ...
      {Object.entries(itemsByVendor).map(([vendorId, items]) => {
        const vendorName =
          items[0]?.vendors[0]?.business_name ?? "Unknown vendor";
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-full bg-[#009688] flex items-center justify-center text-white text-[11px] font-medium">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1 flex-wrap">
                        ...
                        {item.selected_color && (
                          <span className="inline-flex items-center gap-1 text-[11px] px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400">
                            <span
